...
import { Bell, Star, Users, MessageCircle, Trophy, Gift, Settings } from 'lucide-react';
      ...
      <div className="p-6 h-full">
        ...
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-2">
            ...
            <span className="font-semibold dropsource-text-primary">Notifications</span>
            {unreadCount > 0 && (
        ...
        {/* Notifications List */}
        <div className="space-y-3 overflow-y-auto dropsource-custom-scrollbar" style={{ height: 'calc(100% - 140px)' }}>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-start justify-between mb-1">
                      ...
                      <span className="text-xs dropsource-text-tertiary ml-2">
