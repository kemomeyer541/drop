...
export function ScrapbookMenu({
  ...
  const handleMouseDown = (e: React.MouseEvent) => {
    if ((e.target as HTMLElement).closest('.scrapbook-content')) return;
  ...
  return (
    ...
    >
      ...
      {/* Body */}
      <div className="min-h-0 flex-1 overflow-y-auto scrapbook-content">
                  ...
                  >
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-1">
                        <Star className="w-3 h-3" style={{ color: '#00AEEF' }} />
