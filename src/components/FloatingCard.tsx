    ...
    <>
      ...
      >
        ...
        >
          ...
          <div
            ref={dragRef}
            className={`flex items-center justify-between border-b cursor-grab active:cursor-grabbing ${
              isDragging ? 'dropsource-surface' : 'dropsource-panel'
            }`}
            style={{
          ...
          >
            <div className="flex items-center dropsource-spacing-xs">
              <Move className="w-4 h-4 dropsource-text-tertiary dropsource-icon-outlined" />
              <h3 className="dropsource-text-primary select-none" style={{ 
