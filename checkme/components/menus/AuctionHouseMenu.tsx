...
import { getAuctionCollectibles, getRarityColor, getRarityBgColor, buildImagePath } from '../../utils/collectibles';
            ...
            {items.map(item => {
              ...
              return (
                ...
                >
                  ...
                  {/* Item Preview */}
                  <div 
                    className="rounded-lg mb-2 flex items-center justify-center relative aspect-square w-full"
                    style={{ 
                  ...
                  >
                      ...
                      return imgSrc ? (
                        <img
                          ...
                          style={{ 
                            ...
                            objectFit: item.name === 'Pixel Art' ? 'cover' : 'contain',
                            transform: item.name === 'Pixel Art' ? 'scale(2)' : 'scale(1)'
                          }}
                          onError={(e) => {
                    ...
                    <span
                      className="rounded-lg text-white font-bold hidden w-full h-full flex items-center justify-center text-4xl"
